...
این مخزن [گیت هاب](https://github.com/arashyeganeh/Pandas-Tutorial-Persian-Test) حاوی مطالب آموزشی و سورس کدهای تمام آموزش های پانداس می باشد.
...
با همکاری در توسعه این مخزن، در افزایش سطح دانش جامعه برنامه نویسان سهیم خواهید بود.
